...
class Input{
  ...
  actionValedator (action) {
    ...
    console.log('invalid command');
    console.log('please you can usee these action');
    console.log('-a / --add then "the note you want to add"');
    console.log('--list to show all the notes');
    console.log('--delete then "the id of the note to delete it"');
    return null;
